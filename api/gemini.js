...
- articles: array med { articleNumber, quantity } – detta är den AUKTORITATIVA artikellistan som används direkt i gränssnittet, så var extra noggrann här:
  ...
  - ALDRIG ärendenummer inom parentes eller 9-siffriga ordernummer
  - Mejlkedjan innehåller ofta samma mejl flera gånger (citerade svar/trådhistorik) – om samma artikelnummer förekommer i flera citerade kopior av SAMMA ursprungsmejl räknas det EN gång, inte en gång per förekomst
  - quantity är det FAKTISKA antalet kunden vill returnera av just den artikeln, läs hela sammanhanget för att avgöra rätt antal – lita inte på enbart hur många gånger numret nämns i texten
...
OBS: Mejlkedjan kan innehålla samma text flera gånger (citerade svar). Ignorera dubbletter och fokusera på unik information, särskilt för articles-listan.
Kundmejl:
"""
${text}
"""
